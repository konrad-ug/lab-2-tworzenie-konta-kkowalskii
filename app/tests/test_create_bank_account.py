...
class TestCreateBankAccount(unittest.TestCase):
    ...
    def test_numer_pesel(self):
        ...
        self.assertEqual(pesel_nie_isDigit.pesel, "Niepoprawny pesel!", testmsg)
...
class TestCreateBankAccountCompany(unittest.TestCase):
    ...
    def test_przelew_firmowy(self):
        ...
        self.assertEqual(kfirmowe1.historia_przelewow[0], -500,
                         "Niepoprawna wiadomosc zostala zapisana do historii przelewow")

        # próba przelewu kiedy saldo jest zbyt małe
        kfirmowe1.przelew_firma(firmowe, '0443322210', 1000)
        self.assertEqual(kfirmowe1.saldo, -5,
